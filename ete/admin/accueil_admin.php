...
<body>
  ...
  <form method="post" action="../co_admin.php" class="form-signin ">
    ...
    <label for="admin_name" class="sr-only">admin_name</label>
    <input type="text" name="admin_name" id="inputUserName" class="form-control" placeholder="Votre nom" required
      autofocus>
    <label for="inputPassword" class="sr-only">Password</label>
    <input type="password" name="admin_password" id="inputPassword" class="form-control text-center shadow"
